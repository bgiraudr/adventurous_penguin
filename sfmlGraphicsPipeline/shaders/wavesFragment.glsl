...
void main()
{
    ...
    // Modifiez les coordonnées de texture en utilisant une fonction sinusoïdale
    vec2 texCoord = surfel_texCoord;
    texCoord.y += 0.05 * sin(0.1 * length(surfel_position.xz) + time);
