...
{
	bool operator()(const RenderablePtr & a, const RenderablePtr & b) const;
};
...
public:
     ...
     */
    void addRenderable( const RenderablePtr & r );
...
private:
    ...
    std::vector<DirectionalLightPtr> m_directionalLights; /*!< Vector of pointer to the directional light. */
